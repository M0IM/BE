...
import static com.dev.moim.global.common.code.status.ErrorStatus.MISSING_MOIM_ID_IN_URI;

@Slf4j
@Component
@RequiredArgsConstructor
public class AuthUserMoimOwnerArgumentResolver implements HandlerMethodArgumentResolver {
