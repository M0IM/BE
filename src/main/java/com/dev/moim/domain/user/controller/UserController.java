...
public class UserController {
    ...
    // 유저 대표 프로필 조회
    @Operation(summary = "유저 moim 기본 프로필 조회", description = "유저의 moim 기본 프로필을 조회합니다.")
    @ApiResponses(value = {
    ...
    // 사용 유무 확인
    @Operation(summary = "유저 moim 기본 프로필 상세 조회", description = "유저의 moim 기본 프로필을 상세 조회하는 기능입니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "COMMON200", description = "성공입니다."),
    })
